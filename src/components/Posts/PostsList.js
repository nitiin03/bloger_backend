...
export default function PostsList() {
  ...
  const { postLists, appErr, serverErr, loading, likes, dislikes } = post;
          ...
          <div class="container mx-auto px-4">
            ...
            <div class="flex flex-wrap -mx-3">
              ...
              <div class="w-full lg:w-3/4 px-3">
                {/* {Post Goes here} */}
                {appErr || serverErr ? (
                  <h1 className="text-yellow-600 text-center text-xl">
                    {appErr}
                    {serverErr}
                  </h1>
                ) : postLists?.length <= 0 ? (
                  <h1 className="text-yellow-500 text-lg text-center">
                    No Post Found
                  </h1>
                ) : (
                  postLists?.map((post) => (
                        ...
                        <div className="mt-6 flex items-center">
                          ...
                          <div className="ml-3">
                            <p className="text-sm font-medium text-gray-900">
                              <Link to={`/profile/${post?.user?.id}`}>
                                <div className="text-yellow-400 hover:underline ">
